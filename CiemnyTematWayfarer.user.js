...
css+=' \
  ...
  ark-cookiebar-buttons button{background:#222;} \
';
...
/* ustawienia */
css+=' \
  #SettingsController .settings-content .settings-item .item-edit::before{-webkit-filter:invert(100%);filter:invert(100%);} \
...
/* nominacje */
css+='#nom-table-title--arrow::before{-webkit-filter:invert(100%);filter:invert(100%);}';
// karty
css+=' \
